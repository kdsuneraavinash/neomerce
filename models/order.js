...
const getOrderHistory = async (orderID) => {
    const orderHistoryDataObj = {
        customer_info: {}, delivery_info: {}, order_info: {}, items: {},
    };
    let result;
...
module.exports = {
    createOrder, getOrderDetails, getRecentOrders, getOrderHistory, orderHistoryPermissionChecker,
};
